...
/**
 * API를 만들 때는 parameter를 받든 반환하든 엔티티를 직접 사용하지 말 것.
 * -> 중간에 API 스펙에 맞는 DTO를 만들고 활용해야 한다.
 */
@RestController
...
public class MemberApiController {
    ...
    public UpdateMemberResponse updateMemberV2(
        ...
        Member findMember = memberService.findOne(id); // command와 query를 분리하기 위해 member 객체를 새로 persist함.
